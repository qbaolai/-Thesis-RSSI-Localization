...
squarePath = [0.5,0;0.5,0;0.5,0;0.5,0;0.5,0;0.5,0;0.5,0;0.5,0; ...
    ...
    0,30;0,30;0,30;0.5,0;0.5,0;0.5,0;0.5,0;0.5,0;0.5,0;0.5,0;0.5,0; ...
    0,30;0,30;0,30];
squarePath(:,1) = 0.5  ;   % reduce the path length
robotPath = [squarePath;squarePath;squarePath;squarePath;squarePath];
errPer = 0.2;  % odometry error percentage
% End Generate Robot
%--------------------------------------------------------------------------
...
%                 particles(jj,:) = d + normrnd(0,1,[1,numOfNodes]);
    ...
    pause(0.1); % to animate the robot
end
    % End Plot Movement
    %----------------------------------------------------------------------
...
% Calculate + Plot Localization Errors
    ...
    grid on;
    legend('Dead-reckoning error','EKF error');
